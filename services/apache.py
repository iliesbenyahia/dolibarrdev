...
class Apache:
    ...
    def __init__(self, dockerClient, owner):
    ...
    def setup_files(self):
        os.makedirs(os.path.os.getcwd() + "/Users/" + self.owner + "/sources/custom", 511, True)
        if os.path.exists(self.target_dir):
            shutil.rmtree(self.target_dir)
            shutil.copytree(os.path.os.getcwd() + "/static_files/environment/apache", self.target_dir)
            utils.replaceInFiles(self.target_dir,{'${USER}':self.owner})
